...
//    fun setFilterEffect(customEffect: CustomEffect?)
     ...
     *
     * @param filterType type of filter want to apply [com.asoft.collagetool.text.PhotoEditorImpl]
     */
...
//    fun saveAsBitmap(onSaveBitmap: OnSaveBitmap)
     ...
     *
     * @param onPhotoEditorListener [com.asoft.collagetool.text.OnPhotoEditorListener]
     */
...
//    val isCacheEmpty: Boolean
     ...
     */
    class Builder(var context: Context, var photoEditorView: FramePhotoLayout) {

        @JvmField
        var imageView: ImageView = photoEditorView.source ?: ImageView(context)
