...
class StyleStoryAdapter(
    private val onItemClick: (StyleItem) -> Unit
) : ListAdapter<StyleItem, StyleStoryAdapter.StyleViewHolder>(DiffCallback) {

    private var selectedPosition: Int = 0

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StyleViewHolder {
        val binding = ItemStyleComicBinding.inflate(parent.inflater, parent, false)
    ...
    inner class StyleViewHolder(
        private val binding: ItemStyleComicBinding
        ...
        fun bind(style: StyleItem, isSelected: Boolean) {
            binding.apply {
                ...
                imgCheckSelected.visibility = if (isSelected) View.VISIBLE else View.GONE
