 ...
 *
 *
 * This class is used to wrap the styles to apply on the TextView on [com.asoft.artsal.photo.business.text.PhotoEditor.addText] and [com.asoft.artsal.photo.business.text.PhotoEditor.editText]
 *
 *
...
open class TextStyleBuilder {
    ...
    private var fontResourceId: Int? = null
    ...
    /**
     * Set font resource ID for tracking
     *
     * @param resourceId font resource ID
     */
    fun withFontResourceId(resourceId: Int) {
        fontResourceId = resourceId
    }
    
    /**
     * Get font resource ID
     */
    fun getFontResourceId(): Int? = fontResourceId
...
//        textView.setPaintFlags(textView.getPaintFlags()|flag);
    ...
    /**
     * Enum to maintain current supported style properties used on on [com.asoft.artsal.photo.business.text.PhotoEditor.addText] and [com.asoft.artsal.photo.business.text.PhotoEditor.editText]
     */
